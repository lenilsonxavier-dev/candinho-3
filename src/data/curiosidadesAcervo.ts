    ...
    items: [
      {
        ...
        palavrasChave: ["tartaruga ninja", "tartarugas ninja", "ninja turtles", "tartarugas", "raphael", "donatello", "michelangelo", "leonardo", "renascimento", "nome de tartaruga", "porque as tartarugas"]
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        palavrasChave: ["sobrancelha mona lisa", "mona lisa sobrancelha", "sobrancelhas", "olho mona lisa", "detalhe mona lisa"]
      },
      {
        id: "art_sorriso",
        emoji: "🙂",
      ...
      },
      {
        ...
        palavrasChave: ["van gogh vendeu", "quantas pinturas van gogh vendeu", "vinha encarnada", "vendeu quadro van gogh", "reconhecimento van gogh"]
      },
      {
        ...
        palavrasChave: ["capela sistina deitado", "capela sistina tempo", "quatro anos capela", "tempo capela sistina", "teto da capela"]
      },
      {
        ...
        palavrasChave: ["michelangelo deitado", "pintou deitado", "sistina deitado", "michelangelo em pe", "andaimes michelangelo"]
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        palavrasChave: ["significa manga", "significado manga", "o que e manga", "quadrinhos japoneses", "manga em japones"]
      },
      {
        id: "manga_leitura",
        emoji: "📖",
      ...
      },
      {
        ...
        palavrasChave: ["osamu tezuka", "deus do manga", "quem foi osamu", "tezuka manga", "criador do manga"]
      },
      {
        id: "manga_olhos",
        emoji: "👀",
        ...
        palavrasChave: ["olhos grandes manga", "porque olhos grandes", "olhos gigantes", "olhar de anime", "expressao de emocao"]
      },
      {
        id: "manga_variedade",
        emoji: "📚",
        ...
        palavrasChave: ["manga idade", "tipos de manga", "shonen", "shojo", "manga para criancas", "generos manga"]
      },
      {
        id: "manga_anime",
        emoji: "📺",
        ...
        palavrasChave: ["manga vira anime", "diferenca manga anime", "historia papel", "adaptacao anime"]
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        palavrasChave: ["significa anime", "significado anime", "o que e anime", "animacao japonesa", "japao anime"]
      },
      {
        id: "ani_mais_longo",
        emoji: "🐢",
        ...
        palavrasChave: ["anime mais longo", "anime maior", "sazae san", "episodios sazae san", "anime desde 1969"]
      },
      {
        id: "ani_pokemon_nome",
        emoji: "🎒",
        ...
        palavrasChave: ["pokemon nome", "pocket monsters", "origem pokemon", "monstros de bolso", "nome do pokemon"]
      },
      {
        id: "ani_dragon_ball",
        emoji: "🐉",
        ...
        palavrasChave: ["dragon ball brasil", "goku brasil", "popularizou animes", "goku", "akira toriyama"]
      },
      {
        ...
        palavrasChave: ["naruto lendas", "kurama lenda", "kitsune naruto", "folclore de naruto", "mitologia japonesa naruto"]
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        palavrasChave: ["oswald o coelho", "primeiro personagem disney", "oswald lucky rabbit", "coelho mickey", "origem do mickey"]
      },
      {
        id: "des_scooby_raca",
        emoji: "🐶",
        ...
        palavrasChave: ["raca scooby doo", "raca do scooby", "dogue alemao scooby", "scooby doo raca", "raca dogue alemao"]
      },
      {
        ...
        palavrasChave: ["simpsons nomes", "nomes simpsons", "familia de matt groening", "bart significado", "origem simpsons"]
      },
      {
        ...
        palavrasChave: ["tom e jerry falam", "porque tom e jerry nao falam", "tom jerry voz", "audios tom jerry", "dialogos tom jerry"]
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        palavrasChave: ["como funciona animacao", "cerebro animacao", "truque de movimento", "persistência da visão", "quadros por segundo"]
      },
      {
        id: "ger_quadro_mao",
        emoji: "✍️",
        ...
        palavrasChave: ["desenhos antigos", "como era feito antigamente", "quadro a quadro", "desenhar a mao", "acetato desenho"]
      },
      {
        ...
        palavrasChave: ["cores dos personagens", "cores herois", "porque super homem usa azul", "psicologia das cores herois", "cores vilões"]
      }
    ]
  }
];
  ...
  for (const category of CURIOSIDADES_ACERVO) {
    for (const item of category.items) {
      const match = item.palavrasChave.some(kw => {
        ...
        return normMsg.includes(normKw);
      });
